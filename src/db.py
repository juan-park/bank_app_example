...
def seed_db():
    ...
    add_user("john.pip", "John", "Pip", "02/05/1999", "(889) 492-6298", "John.Pip@gmail.com", "505 Hood Rd #1, Markham, Ontario, L3R 5V6, Canada", "testing!",1000)
    add_user("craig.fischer", "Craig", "Fischer", "02/07/202", "(443) 994-7539", "Craig.Fischer@gmail.com", "505 Hood Rd #1, Markham, Ontario, L3R 5V6, Canada", "testing!",50)
    add_user("john.park", "John", "Park", "09/09/1999", "(648) 757-9484", "John.Park@gmail.com", "505 Hood Rd #1, Markham, Ontario, L3R 5V6, Canada", "testing!",20)
    add_user("ash.ketchum", "Ash", "Ketchum", "22/05/1987", "(418) 926-1252", "Ash.Ketchum@gmail.com", "505 Hood Rd #1, Markham, Ontario, L3R 5V6, Canada", "testing!",100000)
